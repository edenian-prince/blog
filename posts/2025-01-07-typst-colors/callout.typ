...
#highlight(fill: green)[this should be green]
...
+ when you find the callout block function, copy it and put it in your typst-template. you might need a basic understanding of Typst in order to see where to place the function. it will look like this:
]
